<script lang="ts">
  import { fade, draw, blur, slide, fly } from "svelte/transition";
  import {
    quintOut,
    quadInOut,
    quadIn,
...
<div transition:fade class="content-container" data-scroll-container>
  ...
  <section class="container-content" data-scroll-section>
    ...
    >
      ...
      <div transition:slide={{ delay: 250, duration: 1000, easing: expoInOut }} class="grey-rec">
        <h2>Lorem ipsum ipsum</h2>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ut ante
          ante. Nam semper, mauris vitae aliquam facilisis, nulla mauris
        ...
        <p>
          ...
          ante tincidunt ex mollis aliquet. Integer et pretium felis. In varius
          finibus eros ut rutrum. Pellentesque mauris libero, scelerisque ut
          ornare id, aliquam nec ex. In vehicula pellentesque vehicula. Aliquam
          consequat erat eu elit egestas, quis malesuada ligula consequat.
          Aenean sit amet posuere massa.
        </p>
      </div>
      {/if}
  ...
  <section class="container-content" data-scroll-section>
    <div class="dashed dashed-top min-h-screen mx-auto content-box">
      <div class="content-realisation flex flex-row items-center">
        ...
        <div class="h-screen bg-gray-100 w-2/3" />
      </div>
    </div>
  </section>
